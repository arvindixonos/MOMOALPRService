#!/usr/bin/env ultimatealprsdk

"""
pyton_setup.py file for SWIG ultimateAlprSdk
You must run this file from 'binaries/os/arch' (e.g. 'binaries/ultimatealprsdkbinaries/x86_64') folder.
"""
...
ultimateAlprSdk_module = Extension('_ultimateAlprSdk',
                           sources=[os.path.abspath('../../../ultimatealprsdk/ultimateALPR-SDK-API-PUBLIC-SWIG_python.cxx')],
                           include_dirs=['../../../c++'],
                           language='c++11',
                           library_dirs=['.'],
                           libraries=[LIBNAME]
...
setup (name = 'ultimateAlprSdk',
       version = '3.0.0',
       author      = "Doubango AI",
       description = """ultimateAlprSdk for ultimatealprsdk""",
